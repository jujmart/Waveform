...
def seed_genres():
    ...
    genre_dict['Rap'].songs.append(perfect_memory)
    genre_dict['Rap'].songs.append(perfect_strangers)
    genre_dict['Rap'].songs.append(prophets)
    genre_dict['Rap'].songs.append(she_knows)
    genre_dict['Rap'].songs.append(sky_full_of_stars)
    genre_dict['Rap'].songs.append(sunflower)
    genre_dict['Rap'].songs.append(too_high)
    genre_dict['Rap'].songs.append(truth_hurts)
    genre_dict['Rap'].songs.append(z)
